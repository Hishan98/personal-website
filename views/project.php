                        ...
                        <div class="col-md-11 projects">
                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="col-md-6 project-data">
                                    ...
                                    <a href="https://admin.dbima.eu/" target="_blank" class="project-btn">
                        ...
                        <div class="col-md-11 projects">
                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="col-md-6 project-data">
                                    ...
                                    <a href="https://dbima.eu/" target="_blank" class="project-btn">
                                        <i class="fas fa-eye pr-1"></i>
                                        Visit Live Site
                                    </a>
                                </div>
                        ...
                        <div class="col-md-11 projects">
                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="col-md-6 project-data">
                                    ...
                                    <p class="project-techTitle">Used Technologies:</p>
                                    <p class="project-techText">Pure PHP/ My SQL/ Javascript/ Bootstrap</p>
                                    <a href="https://cmr-travels.herokuapp.com/" target="_blank" class="project-btn">
                                        <i class="fas fa-eye pr-1"></i>
                                        Visit Live Site
                                    </a>
                                </div>
